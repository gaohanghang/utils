...
public class RSAUtils {
	...
	public static void main(String[] args) throws Exception {
		/*HashMap<String, Object> map = cn.gaohanghang.RSAUtils.getKeys();
        //生成公钥和私钥
        ...
        //使用模和指数生成公钥和私钥
        RSAPublicKey pubKey = cn.gaohanghang.RSAUtils.getPublicKey(modulus, public_exponent);
        RSAPrivateKey priKey = cn.gaohanghang.RSAUtils.getPrivateKey(modulus, private_exponent);
        //加密后的密文
        String mi = cn.gaohanghang.RSAUtils.encryptByPublicKey(ming, pubKey);
        System.err.println("密文："+mi);
        //解密后的明文
        ming = cn.gaohanghang.RSAUtils.decryptByPrivateKey(mi, priKey);
